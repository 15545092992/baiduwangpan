...
(function () {
    ...
    let getAppSettingData = function () {
        return {
            ...
            aria2DownloadUrl: `https://softxm.lanzouw.com/iaeZM0rl0uwb`, // Aria2软件下载地址
            ...
            <div id="downloadDialog">
                ...
                <div id="dialogMiddle">
                    <div id="dialogLeft">
                        <div id="dialogLeftTips">
                            <div id="dialogLeftTips1">
                                ...
                                <div class="dialogLeftTipsLink">
                                    <a href="${getAppSettingData().idmDownloadUrl}" target="_blank">【点击下载IDM】</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${getAppSettingData().idmCourseUrl}" target="_blank">【IDM配置教程】</a>
                                </div>
                            </div>
                        ...
                        <div id="dialogQr">
                            <img id="dialogQrImg" src="https://image.baidu.com/search/down?url=https://tvax2.sinaimg.cn/large/5ce523d9gy1hcxa3bp2rnj20aa0aa755.jpg" />
                        </div>
                    </div>
                    <div id="dialogRight">
